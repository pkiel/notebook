...
capFig("Violin plots of measured abiogenic aragonite FWHM in <strong>A</strong> D17 and <strong>B</strong> MD23. Dashed lines in a are the published curves")
...
Nevertheless here is the calculation of omega and compared to DeCarlo's work:

```{r}
kiel_kiel %>%
  mutate(omega = exp(((fwhm-0.494)-2.148)/0.65)) %>%
