...
We will use dissolved oxygen data both to calculate the average conditions the corals were exposed to and to manipulate incubation data to calculate productivity rates. These are fairly easy calculations we can revist once we collect the data we will analyze.
