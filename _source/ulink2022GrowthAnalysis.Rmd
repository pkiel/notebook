...
weeklyGrowth %>%
  ...
  geom_ribbon(aes(ymin = weeklyG - se,
                    ...
                    fill=genotype),
                alpha=0.3) + 
  labs(title = "Figure 4: Avg Weekly Growth Per Week by Genotype ± se") +
...
weeklyGrowth %>%
  ...
  geom_ribbon(aes(ymin = weeklyG - se,
                    ...
                    fill=treatment),
                alpha=0.3) + 
  labs(title = "Figure 5: Avg Weekly Growth Per Week by Treatment Group ± se") +
  scale_x_continuous("Week",
                     breaks = c(seq(1,
                                    max(weeklyGrowth$weekNum, na.rm = T),
                                    by=1))) +
...
totalGrowth %>%
  ...
  labs(title = "Figure 11: Amount of New CaCO3 Precipated",
