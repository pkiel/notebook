...
Here I created a random intercept model to include tank effect, i.e. including variability within tanks into the model. This decreased the AIC from 44 to 12, and therefore the random tank effect should be included for analysis.
