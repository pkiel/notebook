...
```{r growth graphs}
capFig("Avg Daily Growth Per Week by Genotype ± se")
weeklyGrowth %>%
...
capFig("Avg Daily Growth Per Week by Treatment Group ± se")
weeklyGrowth %>%
...
capFig("Avg Daily Growth Per Week by Genotype and Treatment")
totalGrowth %>%
  ggplot(aes(genotype, dailyG)) +
