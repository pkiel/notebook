...
Salinity, temperature, and total alkalinity were not significantly different between treatments or within treatments (p>>0.05). DIC (p<0.01), pCO2(p<0.001), and $\Omega_{Ar} $ (p<0.001) were significantly different between treatment, but not between aquariums (p>>0.05). In other words, our system reproducibly altered the carbonate chemistry parameters with high precision.
