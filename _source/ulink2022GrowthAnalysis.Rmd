...
labViewData %>%
  ...
  theme_bw() +
  guides(fill = FALSE) +
  labs(title = "Figure 1: 15-min Averaged Log")
```
...
labViewData %>%
  ...
  theme_bw() +
  guides(fill = FALSE) +
  labs(title = "Figure 2: Cleaned 15-min Averaged Log")
```
...
carbSystem %>%
  ...
  labs(x = "Date",
       y = "Time of Day",
       title = "Figure 3: Bottle Sampling of Aquariums")
```
...
weeklyGrowth %>%
  ...
  geom_ribbon(aes(ymin = weeklyG - se,
                    ...
                    fill=genotype),
                alpha=0.3) + 
  labs(title = "Figure 4: Avg Daily Growth Per Week by Genotype ± se") +
  scale_x_continuous("Week",
                     breaks = c(seq(1,
                                    max(weeklyGrowth$weekNum, na.rm = T),
                                    by=1))) +
  scale_y_continuous("Avg Daily Growth Rate (mg/g/day)",
                     limits = c(0,4),
...
weeklyGrowth %>%
  ...
  geom_ribbon(aes(ymin = weeklyG - se,
                    ...
                    fill=treatment),
                alpha=0.3) + 
  labs(title = "Figure 5: Avg Daily Growth Per Week by Treatment Group ± se") +
  scale_x_continuous("Week",
                     breaks = c(seq(1,
                                    max(weeklyGrowth$weekNum, na.rm = T),
                                    by=1))) +
...
totalGrowth %>%
  ggplot(aes(treatment, dailyG, fill=treatment)) +
  geom_boxplot() +
  labs(x = "Treatment",
       y = "Avg Daily Growth Rate (mg/g/day)",
       title = "Figure 6: Avg Daily Growth by Treatment") +
  theme_classic()
...
totalGrowth %>%
  ...
  labs(x = "Treatment",
       y = "Avg Daily Growth Rate (mg/g/day)",
       title = "Figure 7: Avg Daily Growth by Genotype") +
  theme_classic()
...
totalGrowth %>%
  ...
  labs(x = "Genotype",
       y = "Avg Daily Growth Rate (mg/g/day)",
       title = "Figure 8: Avg Daily Growth by Genotype and Treatment") +
  theme_classic()
```
...
totalGrowth %>%
  ggplot(aes(tank, dailyG, fill=treatment)) +
  geom_boxplot() +
  labs(x = "Genotype",
       y = "Avg Daily Growth Rate (mg/g/day)",
       title = "Figure 9: Avg Daily Growth by Tank and Treatment") +
  theme_classic()
...
totalGrowth %>%
  ...
  labs(x = "Genotype",
       y = "Avg Daily Growth Rate (mg/g/day)",
       title = "Figure 10: Avg Daily Growth by Genotype,Treatment, and Tank") +
  theme_classic()
```
...
totalGrowth %>%
  group_by(treatment) %>%
  t_test(data=.,formula = dailyG ~ tank) %>%
    kbl(align = 'c',
    digits = 3,
    caption = "Table 7: Significance testing of tank effect on calcification") %>%
  kable_classic() %>%
  row_spec(0, bold = T)
...
totalGrowth %>%
  ...
  labs(title = "Figure 11: Amount of New CaCO3 Precipitated",
...
height %>%
  ...
  labs(x = "Treatment",
       ...
       title = "Figure 12: Avg Daily Linear Extension by Treatment") +
  theme_classic()
...
height %>%
  ...
  labs(x = "Treatment",
       y = "Avg Daily LE Rate (mm/cm/day)",
       title = "Figure 13: Avg Daily Linear Extension by Treatment and Aquarium") +
  theme_classic()
...
height %>%
  ...
  labs(x = "Genotype",
       y = "Avg Daily LE Rate (mm/cm/day)",
       title = "Figure 14: Avg Daily Linear Extension by Genotype and Treatment") +
  theme_classic()
```
...
groupMeans %>%
  select(-variable) %>%
      kbl(align = 'c',
    digits = 4,
    caption = "Table 9:Means of Treatment") %>%
  kable_classic() %>%
  row_spec(0, bold = T)
...
tTestResults %>%
  kbl(align = 'c',
    digits = 4,
    caption = "Table 10: Stats of Treatment",
    escape=F) %>%
  kable_classic() %>%
  row_spec(0, bold = T)
...
cohensResults %>%
      kbl(align = 'c',
    digits = 4,
    caption = "Table 11: Effect Size of Treatment") %>%
  kable_classic() %>%
  row_spec(0, bold = T)
...
tukeyLE %>%
    kbl(align = 'c',
    digits = 4,
    caption = "Table 12: TukeyHSD Results of Anova",
    escape = F) %>%
  kable_classic() %>%
  row_spec(0, bold = T) %>%
...
height %>%
  ...
  labs(x = "Treatment",
       y = "Avg Daily LE Rate (mm/cm/day)",
       title = "Figure 15: Avg Daily Linear Extension by Treatment and Aquarium") +
  theme_classic()
...
height %>%
  ...
  t_test(data=.,formula = prod ~ tank) %>%
    kbl(align = 'c',
    digits = 3,
    caption = "Figure 16: Significance testing of tank effect on Linear Extension Rates") %>%
  kable_classic() %>%
  row_spec(0, bold = T)
...
emmeans(modRandom, list(pairwise ~genotype*treatment),
  ...
  kbl(align = 'c',
    digits = 4,
    caption = "Table 14:Pairwise comparison of genotypes' sensitivity to OA",
    escape=F) %>%
  kable_classic() %>%
  row_spec(0, bold = T) %>%
  row_spec(4,
...
height %>%
  ...
  geom_hline(yintercept = mean(height$LE),
             color="red") +
  labs(title = "Figure 17: Amount of New Skeleton and Mean New LE (Red Line)",
