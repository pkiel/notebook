...
modisPAR.summary %>%
  ...
  geom_line() +
  scale_x_date(labels = date_format("%b")) +
  labs(title = "Calculated Seasonal PAR",
       x = "Month",
       y= expression(paste("PAR (", mu," ", mol^-2, " ", s^-1,")")))
```
